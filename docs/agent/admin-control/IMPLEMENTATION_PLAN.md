...
| C4 | Managed ingress, shared device lock, durable operation, drain/switch/rollback | CODE + MOCK; maintenance migration/device activation BLOCKED_GATE |
| C5 | Research queue/run lock and effective B receipt | PARTIAL / CODE + MOCK; E1/E2 and E3 pinned receipts implemented, device receipt verification BLOCKED_GATE |
